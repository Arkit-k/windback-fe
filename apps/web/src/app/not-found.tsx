    ...
    <div className="relative min-h-screen w-full overflow-hidden font-sans">
      ...
      <header className="absolute top-0 left-0 z-20 flex w-full items-center px-6 py-5">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-serif text-xl italic text-white">Windback</span>
        </Link>
      </header>
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-start gap-3 pl-[80px] pt-[50px] md:items-start md:justify-center md:pl-[120px] md:pt-0">
        <h1 className="font-serif text-[5rem] italic leading-none tracking-tight text-white drop-shadow-2xl md:text-[10rem]">
          404
        </h1>
        <p className="font-serif text-base italic text-white/90 drop-shadow md:text-xl">

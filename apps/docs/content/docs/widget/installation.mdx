...
For security, the widget only works on domains listed in your allowed origins. Configure them in [Settings > Allowed Origins](https://app.windbackai.com/dashboard/settings/allowed-origins).

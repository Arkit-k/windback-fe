...
Sign up at the [Windback dashboard](https://app.windback.dev/register) with your email, name, and password.
...
```
https://api.windback.dev/api/v1/webhooks/{provider}/{your_public_key}
```
...
Once webhooks start flowing, you'll see churn events in your [dashboard](https://app.windback.dev/dashboard).
